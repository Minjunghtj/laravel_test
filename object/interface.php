...
//インターフェース
interface ProductInterface{ //メソッドしか書けない
public function getProduct();//abstractを使うと中身が書けない  
}


//インターフェース
interface NewsInterface{ //メソッドしか書けない
     public function getNews();//abstractを使うと中身が書けない
...
class BaseProduct{
 ...
 //子クラス・派生クラス・サブクラス
 class Product implements ProductInterface, NewsInterface {//class宣言、頭は大文字から
//interfaceは複数の定数を適用可能
